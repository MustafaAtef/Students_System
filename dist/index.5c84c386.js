...
const loadStudents = async function() {
    _viewDefault.default.showTableSpinner();
    // get students data
    await _students.getStudents();
    // show it in the view
    _viewDefault.default.render(_students.status.students);
    _viewDefault.default.hideTableSpinner();
};
loadStudents();
(function() {
    _viewDefault.default.createStudentHandler(_students.createStudent);
    _viewDefault.default.showEditStudentModalHandler(_students.getStudent);
    _viewDefault.default.editStudentHandler(_students.editStudent);
    _viewDefault.default.deleteStudentHandler(_students.deleteStudent);
    _viewDefault.default.showTemporaryDeletedStudentsHandler(_students.getTempDeletedStudents);
    _viewDefault.default.temporaryDeletedStudentOptionsHandler(_students.optionsTemporaryDeletedStudents);
    _viewDefault.default.searchStudentHandler(_students.searchStudent);
    _viewDefault.default.resetDataHandler(_students.resetData);
})();

},{"core-js/stable":"95FYz","regenerator-runtime/runtime":"1EBPE","./view":"9gMGv","./Students":"jVCX4","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"95FYz":[function(require,module,exports) {
...
class View {
    constructor(){
        ...
        this.tableSpinner = document.querySelector(".students_data .loading-spinner");
        ...
        this.temporaryDeletedModal = document.querySelector(".temporary_deleted_modal");
        this.createStudentModalHandler = new _modal.Modal(this.createStudentModal);
        this.editStudentModalHandler = new _modal.Modal(this.editStudentModal);
        this.deleteModalHandler = new _modal.Modal(this.deleteModal);
        this.temporaryDeletedModalHandler = new _modal.Modal(this.temporaryDeletedModal);
        ...
        this.createStudBtn.addEventListener("click", this.createStudentModalHandler.open.bind(this.createStudentModalHandler));
    ...
    render(students1, type = "view") {
        this.dataTable.innerHTML = "";
        let html;
        if (!students1.length) html = `
            <tr>
                <td colspan="5">
                ${type === "search" ? "No Students With This Name Please Try With                    Another ." : "No Students Exist Please Add One To Be viewed ..."}
                
                </td>
            </tr>
        `;
        else html = students1.map((student)=>{
            return `
            <tr>
                <td>${student.name}</td>
                <td>${student.email}</td>
    ...
    renderTDS(data) {
        ...
        this.temporaryDeletedModal.querySelector(".stds").insertAdjacentHTML("beforeend", html);
    }
    showTableSpinner() {
    ...
    hideModalSpinner(modal1) {
        modal1.querySelector(".loading-spinner").style.display = "none";
    }
    createStudentHandler(createStudent) {
        this.createStudentModal.querySelector(".save").addEventListener("click", async ()=>{
            ...
            const stdEmail = this.createStudentModal.querySelector(".stdEmail").value;
            const stdPhone = this.createStudentModal.querySelector(".stdPhone").value;
            const stdGrade = this.createStudentModal.querySelector(".stdGrade").value;
    ...
    editStudentHandler(editStudent) {
        this.editStudentModal.querySelector(".update").addEventListener("click", (async function() {
    ...
    showEditStudentModalHandler(getStudent) {
        this.dataTable.addEventListener("click", async (e)=>{
            if (e.target.closest(".edit")) {
                ...
                this.editStudentModal.querySelector(".stdPhone").value = student.phone_number;
    ...
    deleteStudentHandler(deleteStudent) {
        this.deleteModal.addEventListener("click", (async function(e) {
    ...
    showTemporaryDeletedStudentsHandler(getTDS) {
        this.tempDeletedBtn.addEventListener("click", (async function() {
            this.temporaryDeletedModalHandler.open.call(this.temporaryDeletedModalHandler);
    ...
    async _handleOptionsTDS(e1, func, type1) {
        this.showModalSpinner(this.temporaryDeletedModal);
        const id = e1.target.closest(`.std-${type1}`).dataset.id;
        const status = await func(type1, id);
    ...
    temporaryDeletedStudentOptionsHandler(optionsTDS) {
        this.temporaryDeletedModal.querySelector(".modal .stds").addEventListener("click", (async function(e) {
            if (e.target.closest(".std-restore")) await this._handleOptionsTDS(e, optionsTDS, "restore");
            if (e.target.closest(".std-delete")) await this._handleOptionsTDS(e, optionsTDS, "delete");
        }).bind(this));
    }
    searchStudentHandler(searchStudent) {
        this.searchStudentsBtn.addEventListener("click", (function() {
    ...
    resetDataHandler(resetData) {
        this.resetDataBtn.addEventListener("click", (function() {
            this.showTableSpinner();
            this.searchStudentsInput.value = "";
...
},{"./modal":"6uy9L","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"6uy9L":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Modal {
    ...
    escClose(e) {
        if (e.code === 'Escape' && this.opened) this.close();
    }
}
...
},{}],"jVCX4":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "createStudent", ()=>createStudent
);
parcelHelpers.export(exports, "getStudent", ()=>getStudent
);
parcelHelpers.export(exports, "editStudent", ()=>editStudent
);
parcelHelpers.export(exports, "deleteStudent", ()=>deleteStudent
);
parcelHelpers.export(exports, "getTempDeletedStudents", ()=>getTempDeletedStudents
);
parcelHelpers.export(exports, "optionsTemporaryDeletedStudents", ()=>optionsTemporaryDeletedStudents
);
parcelHelpers.export(exports, "searchStudent", ()=>searchStudent
);
parcelHelpers.export(exports, "resetData", ()=>resetData
);
const status = {
    students: [],
    deletedStudents: [],
...
const editStudent = async function(id, data) {
...
const deleteStudent = async function(method, id) {
    if (method === "PERM") {
        await fetch(`${API_URL}${id}`, {
            method: "DELETE"
        });
...
const getTempDeletedStudents = async function() {
    status.deletedStudents = await getJSON(`${API_URL}?isDeleted=true`);
    return status.deletedStudents;
};
const optionsTemporaryDeletedStudents = async function(option, id) {
    if (option === "restore") {
        const student = await getStudent(id);
...
const searchStudent = function(student) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}]},["5qWSS","ijsRf"], "ijsRf", "parcelRequire136d")
